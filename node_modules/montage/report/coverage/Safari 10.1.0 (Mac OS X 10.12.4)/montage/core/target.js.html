...
<html lang="en">
<head>
    <title>Code coverage report for montage/core/target.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">montage/core/</a> target.js
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >            return this === defaultEventManager.activeTarget;</span>
        }
    },
&nbsp;
    /**
...
&nbsp;
    ...
    removeEventListener: {
        value: function removeEventListener(type, listener, useCapture) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (listener) {
...
&nbsp;
    ...
    loadComposer: {
        value: function (composer) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (composer &amp;&amp; !composer._isLoaded) {
