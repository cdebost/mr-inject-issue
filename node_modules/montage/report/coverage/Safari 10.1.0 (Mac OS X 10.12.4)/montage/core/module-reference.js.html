...
<html lang="en">
<head>
    <title>Code coverage report for montage/core/module-reference.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">montage/core/</a> module-reference.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    initWithIdAndRequire: {
        value: function (id, require) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (!id || ! require) {
<span class="cstat-no" title="statement not covered" >                throw new Error("Module ID and require required");</span>
            }
            this.id = id;
...
<span class="cstat-no" title="statement not covered" >            if (this._exports) {</span>
<span class="cstat-no" title="statement not covered" >                return this._exports;</span>
            }
<span class="cstat-no" title="statement not covered" >            return this._exports = this.require.async(this.id);</span>
        }
    },
&nbsp;
    /**
