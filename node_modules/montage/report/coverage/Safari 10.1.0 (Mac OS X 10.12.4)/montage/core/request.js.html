...
<html lang="en">
<head>
    <title>Code coverage report for montage/core/request.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">montage/core/</a> request.js
    </h1>
    <div class='clearfix'>
...
exports = module.exports = function doRequest(request) {
    ...
    var done = new Promise(function(resolve, reject) {
        var xhr = request.xhr || <span class="branch-1 cbranch-no" title="branch not covered" >new XMLHttpRequest();</span>
...
&nbsp;
        ...
        xhr.onerror = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >            reject(new Error("Could not load"));</span>
        };
&nbsp;
