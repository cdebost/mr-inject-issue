...
<html lang="en">
<head>
    <title>Code coverage report for montage/core/event/action-event-listener.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">montage/core/event/</a> action-event-listener.js
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >            if (typeof this.action === "function") {</span>
<span class="cstat-no" title="statement not covered" >                var context = this.handler ? this.handler : this;</span>
<span class="cstat-no" title="statement not covered" >                this.action.call(context, event);</span>
            } else <span class="cstat-no" title="statement not covered" >if (this.handler &amp;&amp; this.action) {</span>
<span class="cstat-no" title="statement not covered" >                this.handler[this.action](event);</span>
            }
        }
    },
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            serializer.set("handler", this.handler, "reference");</span>
            // TODO accepting an actual function is less than ideal from the
            // serialization standpoint
<span class="cstat-no" title="statement not covered" >            serializer.set("action", this.action);</span>
        }
    }
&nbsp;
}, {
