...
<html lang="en">
<head>
    <title>Code coverage report for montage/core/serialization/serializer/montage-malker.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">all files</a> / <a href="index.html">montage/core/serialization/serializer/</a> montage-malker.js
    </h1>
    <div class='clearfix'>
    ...
    _getObjectType: {
        value: function(object) {
            var visitor = this._visitHandler,
                type;
&nbsp;
            <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof visitor.getTypeOf === "function") {
...
&nbsp;
    _enterCustomObject: {
        value: <span class="fstat-no" title="function not covered" >function(type, object, name) {</span>
<span class="cstat-no" title="statement not covered" >            this._callVisitorMethod("enter" + type, object, name);</span>
<span class="cstat-no" title="statement not covered" >            this._callVisitorMethod("exit" + type, object, name);</span>
        }
    },
&nbsp;
    _visitObject: {
...
&nbsp;
            if (this._isObjectEntered(object)) {
                ...
                <span class="missing-if-branch" title="else path not taken" >E</span>if (willEnterObject !== false) {
...
&nbsp;
            if (this._isObjectEntered(array)) {
                ...
                <span class="missing-if-branch" title="else path not taken" >E</span>if (willEnterArray !== false) {
...
&nbsp;
exports.visit = <span class="fstat-no" title="function not covered" >function(object, visitHandler) {</span>
<span class="cstat-no" title="statement not covered" >    var malker = new MontageWalker(visitHandler);</span>
<span class="cstat-no" title="statement not covered" >    malker.visit(object);</span>
};
&nbsp;</pre></td></tr>
</table></pre>
