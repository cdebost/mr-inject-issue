...
<html lang="en">
<head>
    <title>Code coverage report for montage/core/serialization/serializer/montage-builder.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">all files</a> / <a href="index.html">montage/core/serialization/serializer/</a> montage-builder.js
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >            this._references = null;</span>
<span class="cstat-no" title="statement not covered" >            this._root = null;</span>
<span class="cstat-no" title="statement not covered" >            this._stack = null;</span>
        }
    },
&nbsp;
...
&nbsp;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (references) {
<span class="cstat-no" title="statement not covered" >                references = references.slice(0);</span>
<span class="cstat-no" title="statement not covered" >                for (var i = 0, ii = references.length; i &lt; ii; i++) {</span>
<span class="cstat-no" title="statement not covered" >                    references[i].value = newLabel;</span>
                }
            }
        }
    },
...
&nbsp;
    _unregisterReference: {
        value: <span class="fstat-no" title="function not covered" >function(reference) {</span>
<span class="cstat-no" title="statement not covered" >            var label = reference.label,</span>
                labelReferences = this._references[label],
                ix;
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (labelReferences.length === 1) {</span>
<span class="cstat-no" title="statement not covered" >                delete this._references[label];</span>
            } else {
<span class="cstat-no" title="statement not covered" >                ix = labelReferences.indexOf(reference);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (ix === -1) {</span>
<span class="cstat-no" title="statement not covered" >                    console.log("BUG: reference '" + label + "' not found in registry.");</span>
                } else {
<span class="cstat-no" title="statement not covered" >                    labelReferences.splice(ix, 1);</span>
                }
            }
        }
    },
