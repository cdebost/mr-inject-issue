...
<html lang="en">
<head>
    <title>Code coverage report for montage/ui/control.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">montage/ui/</a> control.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">70.89% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>56/79</span>
      </div>
      <div class='fl pad1y space-right2'>
...
486
487
488</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
    ...
    detail: {
        get: function () {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (this._detail == null) {
...
&nbsp;
    enabled: {
        ...
        set: function (value) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof value === "boolean") {
                this.disabled = !value;
            }
        }
    },
...
<span class="cstat-no" title="statement not covered" >            this._focusBlur = 1;</span>
<span class="cstat-no" title="statement not covered" >            this.needsDraw = true;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (!this.preparedForActivationEvents) {</span>
<span class="cstat-no" title="statement not covered" >                this._prepareForActivationEvents();</span>
            }
        }
    },
&nbsp;
    blur: {
        value: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >            this._focusBlur = 0;</span>
<span class="cstat-no" title="statement not covered" >            this.needsDraw = true;</span>
        }
    },
&nbsp;
...
&nbsp;
          <span class="missing-if-branch" title="if path not taken" >I</span>if (this._focusBlur === 1) {
<span class="cstat-no" title="statement not covered" >                this._element.focus();</span>
            } else <span class="missing-if-branch" title="if path not taken" >I</span>if (this._focusBlur === 0 || !this.drawsFocusOnPointerActivation) {
<span class="cstat-no" title="statement not covered" >                this._element.blur();</span>
            }
...
<span class="cstat-no" title="statement not covered" >            return this._preventFocus;</span>
        },
        set: function (value) {
...
<span class="cstat-no" title="statement not covered" >            this.hasFocus = true;</span>
<span class="cstat-no" title="statement not covered" >            this.drawsFocusOnPointerActivation = true;</span>
        }
    },
&nbsp;
    handleBlur: {
        enumerable: false,
        value: <span class="fstat-no" title="function not covered" >function (event) {</span>
<span class="cstat-no" title="statement not covered" >            this.hasFocus = false;</span>
<span class="cstat-no" title="statement not covered" >            this.drawsFocusOnPointerActivation = false;</span>
<span class="cstat-no" title="statement not covered" >            this.callDelegateMethod("didEndEditing", this);</span>
            //This create an issue in textfield, to investigate
<span class="cstat-no" title="statement not covered" >            this.dispatchActionEvent();</span>
        }
    },
&nbsp;
    _value: {
...
&nbsp;
            if (value !== this._value) {
                ...
                <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.delegate ||  (shouldAcceptValue = this.callDelegateMethod("shouldAcceptValue", this, value) ) === undefined ? true : <span class="branch-1 cbranch-no" title="branch not covered" >shouldAcceptValue </span>){
                    // console.log("_setValue past first step value is ",value);
&nbsp;
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.converter) {
<span class="cstat-no" title="statement not covered" >                        var convertedValue;</span>
<span class="cstat-no" title="statement not covered" >                        try {</span>
                            //Where is the matching convert?
<span class="cstat-no" title="statement not covered" >                            convertedValue = this.converter.revert(value);</span>
<span class="cstat-no" title="statement not covered" >                            this.error = null;</span>
<span class="cstat-no" title="statement not covered" >                            this._value = convertedValue;</span>
                        } catch (e) {
...
<span class="cstat-no" title="statement not covered" >                            this.error = value !== "" &amp;&amp; value !== void 0 &amp;&amp; value !== null ? e : null;</span>
                        }
                    } else {
                        this._value = value;
                        this.error = null;
...
*/
    error: {
        ...
        set: function (v) {
            this._error = v;
            this.errorMessage = this._error ? <span class="branch-0 cbranch-no" title="branch not covered" >this._error.message </span>: null;
            this.needsDraw = true;
        }
    },
&nbsp;
...
&nbsp;
    ...
    errorMessage: {
        get: <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >            return this._errorMessage;</span>
        },
        set: function (v) {
