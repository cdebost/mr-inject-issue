...
<html lang="en">
<head>
    <title>Code coverage report for montage/composer/key-composer.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">montage/composer/</a> key-composer.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    ...
    keys: {
        ...
        set: function (keys) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (this._keyRegistered) {
<span class="cstat-no" title="statement not covered" >                KeyManagerProxy.defaultKeyManager.unregisterKey(this);</span>
<span class="cstat-no" title="statement not covered" >                this._keys = keys;</span>
<span class="cstat-no" title="statement not covered" >                KeyManagerProxy.defaultKeyManager.registerKey(this);</span>
            } else {
                this._keys = keys;
            }
        }
...
&nbsp;
            <span class="missing-if-branch" title="else path not taken" >E</span>if (type == KEYPRESS_EVENT_TYPE || type == LONGKEYPRESS_EVENT_TYPE || type == KEYRELEASE_EVENT_TYPE) {
                this._shouldDispatchEvent = true;
                <span class="missing-if-branch" title="if path not taken" >I</span>if (type == LONGKEYPRESS_EVENT_TYPE) {
<span class="cstat-no" title="statement not covered" >                    this._shouldDispatchLongPress = true;</span>
                }
&nbsp;
                if (this._isLoaded) {
                ...
                } else <span class="missing-if-branch" title="if path not taken" >I</span>if (component &amp;&amp; typeof component.addComposer !== "function") {
...
<span class="cstat-no" title="statement not covered" >                        this.element = window;</span>
                    }
                    // this keyComposer is not attached to a UI Component,
                    // let's load it manually
<span class="cstat-no" title="statement not covered" >                    this.component.loadComposer(this);</span>
                }
            }
        }
    },
...
<span class="cstat-no" title="statement not covered" >            var component = this.component;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (this.identifier === null) {</span>
<span class="cstat-no" title="statement not covered" >                this.identifier = Montage.getInfoForObject(this).label;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (component) {</span>
<span class="cstat-no" title="statement not covered" >                if (typeof component.addComposer == "function") {</span>
<span class="cstat-no" title="statement not covered" >                    component.addComposer(this);</span>
                } else <span class="cstat-no" title="statement not covered" >if (!this._isLoaded) {</span>
                    // this keyComposer is not associated with an element,
                    // let's make it a global key
<span class="cstat-no" title="statement not covered" >                    if (!this.element) {</span>
<span class="cstat-no" title="statement not covered" >                        this.element = window;</span>
...
&nbsp;
    ...
    createKey: {
        value: function (component, keys, identifier) {
            var key = this;
&nbsp;
            <span class="missing-if-branch" title="else path not taken" >E</span>if (this === KeyComposer) {
...
<span class="cstat-no" title="statement not covered" >                if (component.identifier) {</span>
<span class="cstat-no" title="statement not covered" >                    identifier = component.identifier + keys.toLowerCase().replace(/[ +]/g).toCapitalized();</span>
                } else {
<span class="cstat-no" title="statement not covered" >                    identifier = keys.toLowerCase().replace(/[ +]/g);</span>
                }
            }
            key.keys = keys;
...
&nbsp;
     ...
     */
    createGlobalKey: {
        value: <span class="fstat-no" title="function not covered" >function (component, keys, identifier) {</span>
<span class="cstat-no" title="statement not covered" >            var key = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (this === KeyComposer) {</span>
                // This function has been called without creating a new
                // instance of KeyComposer first
<span class="cstat-no" title="statement not covered" >                key = new KeyComposer();</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            key.keys = keys;</span>
<span class="cstat-no" title="statement not covered" >            key.identifier = identifier;</span>
            // console.log("CREATING GLOBAL KEY:", component, key);
&nbsp;
<span class="cstat-no" title="statement not covered" >            component.addComposerForElement(key, window);</span>
&nbsp;
...
&nbsp;
            if (!this._defaultKeyManager) {
                ...
                <span class="missing-if-branch" title="else path not taken" >E</span>if (!this._loadingDefaultKeyManager) {
...
&nbsp;
    ...
    unregisterKey: {
        value: function (keyComposer) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (this._defaultKeyManager) {
...
&nbsp;
    ...
    defaultKeyManager: {
        get: function () {
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (this._defaultKeyManager) {
<span class="cstat-no" title="statement not covered" >                return this._defaultKeyManager;</span>
            } else {
