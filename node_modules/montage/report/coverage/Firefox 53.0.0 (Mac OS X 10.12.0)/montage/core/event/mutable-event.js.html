...
&nbsp;
        ...
        getPreventDefault: {
            value: function () {
                <span class="missing-if-branch" title="else path not taken" >E</span>if (this._event.getPreventDefault) {
                    return this._event.getPreventDefault();
                }
<span class="cstat-no" title="statement not covered" >                return this._event.defaultPrevented;</span>
            }
        },
&nbsp;
        /**
