...
<html lang="en">
<head>
    <title>Code coverage report for montage/core/tree-controller.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">montage/core/</a> tree-controller.js
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >            return this.controller.isNodeExpanded(this.data);</span>
        },
...
<span class="cstat-no" title="statement not covered" >                this.controller.expandNode(this.data);</span>
            } else {
<span class="cstat-no" title="statement not covered" >                this.controller.collapseNode(this.data);</span>
            }
        }
    }
&nbsp;
...
&nbsp;
    ...
    childrenExpression: {
        get: function () {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (this._childrenExpression === null) {
                return "children";
            }
<span class="cstat-no" title="statement not covered" >            return this._childrenExpression;</span>
        },
        set: function (value) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (this._childrenExpression !== value) {
...
<span class="cstat-no" title="statement not covered" >                    this._childrenExpressionProperty = "children";</span>
                }
            }
        }
    },
...
&nbsp;
    ...
    data: {
        ...
        set: function (value) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (this._data !== value) {
                this._expansionMap = new WeakMap();
                this._data = value;
                <span class="missing-if-branch" title="if path not taken" >I</span>if (this.initiallyExpanded) {
<span class="cstat-no" title="statement not covered" >                    this.expandAll();</span>
                } else {
...
&nbsp;
    ...
    expandAll: {
        value: function () {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (this._data) {
