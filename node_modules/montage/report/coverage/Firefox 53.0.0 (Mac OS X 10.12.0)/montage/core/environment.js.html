...
<html lang="en">
<head>
    <title>Code coverage report for montage/core/environment.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">montage/core/</a> environment.js
    </h1>
    <div class='clearfix'>
...
311
312
313</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1×</span>
...
&nbsp;
    constructor: {
        value: function Environment (userAgent) {
            this.userAgent = userAgent ?  userAgent : global.navigator ? global.navigator.userAgent : <span class="branch-1 cbranch-no" title="branch not covered" >'';</span>
        }
    },
&nbsp;
    _userAgent: {
...
&nbsp;
            <span class="missing-if-branch" title="else path not taken" >E</span>if (userAgent !== this._userAgent) {
...
&nbsp;
                <span class="missing-if-branch" title="else path not taken" >E</span>if (match &amp;&amp; match.length) {
                    this._device = match[0];
&nbsp;
                } else {
<span class="cstat-no" title="statement not covered" >                    this._device = UNKNOWN;</span>
                }
            }
&nbsp;
            return this._device;
...
<span class="cstat-no" title="statement not covered" >            return typeof this._supportsPointerEvents !== "boolean" ?</span>
...
&nbsp;
    isStandalone: {
        get: <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >            return typeof this._isStandalone !== "boolean" ?</span>
...
&nbsp;
                } else <span class="missing-if-branch" title="else path not taken" >E</span>if (this.isIOSDevice) {
                    this._platformName = Environment.Platform.IOS;
&nbsp;
                } else {
<span class="cstat-no" title="statement not covered" >                    this._platformName = UNKNOWN;</span>
                }
            }
&nbsp;
...
&nbsp;
    browserVersion: {
        get: <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >            if (typeof this._browserVersion !== "string") {</span>
<span class="cstat-no" title="statement not covered" >                this._analyzeBrowser();</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            return this._browserVersion;</span>
        }
    },
&nbsp;
    _browserName: {
...
&nbsp;
    browserName: {
        get: function () {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof this._browserName !== "string") {
...
&nbsp;
    isWKWebView: {
        get: <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >            return typeof this._isWKWebView !== "boolean" ?</span>
...
&nbsp;
    isUIWebView: {
        get: <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >            return typeof this._isUIWebView !== "boolean" ?</span>
...
&nbsp;
            <span class="missing-if-branch" title="else path not taken" >E</span>if (match &amp;&amp; match.length &gt; 1) {
                browserName = match[1];
&nbsp;
...
&nbsp;
                    ...
                    browserVersion = match &amp;&amp; match.length &gt; 1 ? match[1] : <span class="branch-1 cbranch-no" title="branch not covered" >'';</span>
                }
&nbsp;
