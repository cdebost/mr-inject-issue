...
<html lang="en">
<head>
    <title>Code coverage report for montage/core/serialization/serializer/montage-ast.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">all files</a> / <a href="index.html">montage/core/serialization/serializer/</a> montage-ast.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    clearLabel: {
        value: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >            this.root.clearProperty(this.label);</span>
...
&nbsp;
    constructor: {
        value: <span class="fstat-no" title="function not covered" >function ReferenceableValue(root, value) {</span>
<span class="cstat-no" title="statement not covered" >            Value.call(this, root, value);</span>
        }
    },
&nbsp;
    toJSON: {
...
&nbsp;
    clearProperty: {
        value: <span class="fstat-no" title="function not covered" >function(name) {</span>
<span class="cstat-no" title="statement not covered" >            delete this.value[name];</span>
        }
    },
&nbsp;
    getPropertyNames: {
...
&nbsp;
            return {"/": {
                ...
                flags: (regexp.global ? "g" : <span class="branch-1 cbranch-no" title="branch not covered" >"")</span> + (regexp.ignoreCase ? "i" : "") + (regexp.multiline ? "m" : "")
            }};
        }
    }
});
