...
<html lang="en">
<head>
    <title>Code coverage report for montage/core/criteria.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">montage/core/</a> criteria.js
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >            return this._expression</span>
        }
    },
    parameters: {
        value: null
...
&nbsp;
    criteriaWithParameters: {
        value: <span class="fstat-no" title="function not covered" >function (parameters) {</span>
<span class="cstat-no" title="statement not covered" >            var clone = (new this.constructor).initWithExpression(this.expression);</span>
<span class="cstat-no" title="statement not covered" >            clone.parameters = parameters;</span>
...
&nbsp;
    serializeSelf: {
        value: function (serializer) {
            serializer.setProperty("expression", this._expression || (<span class="branch-1 cbranch-no" title="branch not covered" >this._expression = stringify(this.syntax))</span>);
...
&nbsp;
                    <span class="missing-if-branch" title="else path not taken" >E</span>if(expression.length &gt; 0) {
                        expression += " &amp;&amp; ";
                    }
                    expression += jExpression;
                }
                else {
                    <span class="missing-if-branch" title="if path not taken" >I</span>if(expression.length &gt; 0) {
<span class="cstat-no" title="statement not covered" >                        expression += " &amp;&amp; ";</span>
                    }
&nbsp;
                    expression += iKey;
                    expression += "== $";
    ...
    Montage.defineProperty(Criteria.prototype, type, {
        value: function () {
            var args = Array.prototype.map.call(arguments, function (argument) {
                <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof argument === "string") {
                    return parse(argument);
                } else <span class="cstat-no" title="statement not covered" >if (argument.syntax) {</span>
<span class="cstat-no" title="statement not covered" >                    return argument.syntax;</span>
                } else <span class="cstat-no" title="statement not covered" >if (typeof argument === "object") {</span>
