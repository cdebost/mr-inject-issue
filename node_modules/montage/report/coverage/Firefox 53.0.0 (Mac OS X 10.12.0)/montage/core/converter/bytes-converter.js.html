...
<html lang="en">
<head>
    <title>Code coverage report for montage/core/converter/bytes-converter.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">montage/core/converter/</a> bytes-converter.js
    </h1>
    <div class='clearfix'>
...
var numBytesToString = function (val, opt_decimals, opt_suffix) {
    var suffix = '';
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!isDef(opt_suffix) || <span class="branch-1 cbranch-no" title="branch not covered" >opt_suffix)</span> {
        suffix = 'B';
    }
