...
<html lang="en">
<head>
    <title>Code coverage report for montage/ui/overlay.reel/overlay.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">montage/ui/overlay.reel/</a> overlay.js
    </h1>
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>49/68</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<span class="cstat-no" title="statement not covered" >                    this._pressComposer.addEventListener("pressStart", this, false);</span>
                } else {
...
<span class="cstat-no" title="statement not covered" >            return this._dismissOnExternalInteraction;</span>
        }
    },
&nbsp;
    enterDocument: {
...
&nbsp;
    ...
    show: {
        value: function () {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (!this._isShown) {
                if (this.isModal) {
...
&nbsp;
    shouldComposerSurrenderPointerToComponent: {
        value: <span class="fstat-no" title="function not covered" >function (composer, pointer, component) {</span>
<span class="cstat-no" title="statement not covered" >            if (component &amp;&amp; component.element &amp;&amp; !this.element.contains(component.element)) {</span>
    ...
    surrendersActiveTarget: {
        value: function (candidateActiveTarget) {
            var response = !(this.isModal &amp;&amp; this.isShown),
                delegateResponse;
&nbsp;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (!response &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >candidateActiveTarget </span>&amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >candidateActiveTarget.element)</span> {
<span class="cstat-no" title="statement not covered" >                response = this.element.contains(candidateActiveTarget.element);</span>
            }
&nbsp;
...
&nbsp;
            return delegateResponse !== void 0 ? <span class="branch-0 cbranch-no" title="branch not covered" >delegateResponse </span>: response;
        }
    },
&nbsp;
    // Event handlers
...
&nbsp;
    handleKeyPress: {
        value: function (event) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (event.identifier === "escape") {
                this.dismissOverlay(event);
            }
        }
    },
...
<span class="cstat-no" title="statement not covered" >            if (!this._isShown) {</span>
...
&nbsp;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (delegatePosition) {
<span class="cstat-no" title="statement not covered" >                position = delegatePosition;</span>
            }
&nbsp;
    ...
    _calculateAnchorPosition: {
        value: function () {
            var anchor = this.anchor,
                ...
                anchorHeight = anchor.offsetHeight || <span class="branch-1 cbranch-no" title="branch not covered" >0,</span>
                anchorWidth = anchor.offsetWidth || <span class="branch-1 cbranch-no" title="branch not covered" >0,</span>
                position;
&nbsp;
            position = {
