...
<html lang="en">
<head>
    <title>Code coverage report for montage/ui/base/abstract-alert.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">montage/ui/base/</a> abstract-alert.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
            <span class="missing-if-branch" title="else path not taken" >E</span>if (firstTime) {
                ...
                <span class="missing-if-branch" title="else path not taken" >E</span>if (this === constructor._instance) {
...
&nbsp;
    handleAction: {
        value: function (event) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (event.target === this._okButton) {
