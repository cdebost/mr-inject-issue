...
<html lang="en">
<head>
    <title>Code coverage report for montage/ui/base/abstract-button.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">montage/ui/base/</a> abstract-button.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    willBecomeActiveTarget: {
        value: <span class="fstat-no" title="function not covered" >function (previousActiveTarget) {</span>
&nbsp;
        }
    },
&nbsp;
...
&nbsp;
            <span class="missing-if-branch" title="else path not taken" >E</span>if (!this._preventFocus) {
                this._element.focus();
            }
        }
    },
...
<span class="cstat-no" title="statement not covered" >                    if (this._label === undefined) {</span>
<span class="cstat-no" title="statement not covered" >                        this.label = this._labelNode.data;</span>
                    }
                }
&nbsp;
