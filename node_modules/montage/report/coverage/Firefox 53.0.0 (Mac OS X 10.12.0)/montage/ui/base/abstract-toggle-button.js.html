...
<html lang="en">
<head>
    <title>Code coverage report for montage/ui/base/abstract-toggle-button.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">montage/ui/base/</a> abstract-toggle-button.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    _toggle: {
        value: <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >            this.pressed = !this.pressed;</span>
        }
    },
&nbsp;
    /**
...
&nbsp;
    enterDocument: {
        value: <span class="fstat-no" title="function not covered" >function (firstDraw) {</span>
<span class="cstat-no" title="statement not covered" >            if(firstDraw) {</span>
<span class="cstat-no" title="statement not covered" >                this.isInputElement = (this.originalElement.tagName === "INPUT");</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (!this.isInputElement) {</span>
<span class="cstat-no" title="statement not covered" >                    if (!this.originalElement.firstChild) {</span>
<span class="cstat-no" title="statement not covered" >                        this.originalElement.appendChild(document.createTextNode(""));</span>
                    }
<span class="cstat-no" title="statement not covered" >                    this._labelNode = this.originalElement.firstChild;</span>
                }
&nbsp;
<span class="cstat-no" title="statement not covered" >                this.element.setAttribute("role", "button");</span>
            }
        }
    },
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            if (this.isInputElement) {</span>
<span class="cstat-no" title="statement not covered" >                this._element.setAttribute("value", value);</span>
            } else <span class="cstat-no" title="statement not covered" >if (this._labelNode) {</span>
...
&nbsp;
    draw: {
        value: <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >            if (this.pressed) {</span>
<span class="cstat-no" title="statement not covered" >                this._drawLabel(this.pressedLabel);</span>
            } else {
<span class="cstat-no" title="statement not covered" >                this._drawLabel(this.unpressedLabel);</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            this.element.setAttribute("aria-pressed", this.pressed);</span>
        }
    }
&nbsp;
});
