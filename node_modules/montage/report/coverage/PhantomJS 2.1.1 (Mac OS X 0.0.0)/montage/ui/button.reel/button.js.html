...
<html lang="en">
<head>
    <title>Code coverage report for montage/ui/button.reel/button.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">montage/ui/button.reel/</a> button.js
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >            var test = <span class="fstat-no" title="function not covered" >function promiseResolved(){</span></span>
<span class="cstat-no" title="statement not covered" >                            if (promiseResolved.promise === self._promise){</span>
<span class="cstat-no" title="statement not covered" >                                self.classList.remove('montage--pending');</span>
<span class="cstat-no" title="statement not covered" >                                self._promise = undefined;</span>
                            }
                        };
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (this._promise !== value) {</span>
<span class="cstat-no" title="statement not covered" >                this._promise = value;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (this._promise){</span>
<span class="cstat-no" title="statement not covered" >                    this.classList.add('montage--pending')</span>
<span class="cstat-no" title="statement not covered" >                    test.promise = value;</span>
<span class="cstat-no" title="statement not covered" >                    this._promise.then(test);</span>
                }
            }
        }
    },
&nbsp;
    ...
    */
    holdThreshold: {
        get: <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >            return this._pressComposer.longPressThreshold;</span>
        },
        set: function (value) {
...
&nbsp;
    _spaceKeyComposer: {
        get: function () {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.__spaceKeyComposer) {
...
&nbsp;
    _enterKeyComposer: {
        get: function () {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.__enterKeyComposer) {
...
&nbsp;
    handleKeyPress: {
        value: <span class="fstat-no" title="function not covered" >function (mutableEvent) {</span>
            // when focused action event on spacebar &amp; enter
            // FIXME - property identifier is not set on the mutable event
<span class="cstat-no" title="statement not covered" >            if (mutableEvent._event.identifier === "space" ||</span>
                mutableEvent._event.identifier === "enter") {
<span class="cstat-no" title="statement not covered" >                this.active = false;</span>
<span class="cstat-no" title="statement not covered" >                this._dispatchActionEvent();</span>
            }
        }
    },
&nbsp;
    ...
    */
    handlePressStart: {
        value: function (event) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (!this._promise){
                this.active = true;
...
&nbsp;
    ...
    */
    ...
    isInputElement: {
        get: function() {
            return this._isInputElement !== undefined ? this._isInputElement : (this._isInputElement = (this.element ? (this.element.tagName === "INPUT") : <span class="branch-1 cbranch-no" title="branch not covered" >false)</span>);
        },
        enumerable: false
    },
&nbsp;
    enterDocument: {
        value: function (firstDraw) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (Control.prototype.enterDocument) {
<span class="cstat-no" title="statement not covered" >                Control.prototype.enterDocument.apply(this, arguments);</span>
            }
&nbsp;
            <span class="missing-if-branch" title="else path not taken" >E</span>if (firstDraw) {
                // Only take the value from the element if it hasn't been set
                // elsewhere (i.e. in the serialization)
                <span class="missing-if-branch" title="else path not taken" >E</span>if (this.isInputElement) {
...
<span class="cstat-no" title="statement not covered" >                            return this._label;</span>
                        ...
                        set: <span class="fstat-no" title="function not covered" >function(value) {</span>
<span class="cstat-no" title="statement not covered" >                            this.label = value;</span>
                        }
                    });
&nbsp;
                    <span class="missing-if-branch" title="else path not taken" >E</span>if (this._label === undefined) {
                        this.label = this.originalElement.value;
                    }
                    //&lt;button&gt; &amp;&amp; Custom
                } else {
<span class="cstat-no" title="statement not covered" >                    if(!this.originalElement !== this.element &amp;&amp; this._label === undefined) {</span>
<span class="cstat-no" title="statement not covered" >                        this._label = this.originalElement.data;</span>
                    }
<span class="cstat-no" title="statement not covered" >                    if (!this.element.firstChild) {</span>
<span class="cstat-no" title="statement not covered" >                        this.element.appendChild(document.createTextNode(""));</span>
                    }
<span class="cstat-no" title="statement not covered" >                    this._labelNode = this.element.firstChild;</span>
    ...
    */
    _drawLabel: {
        ...
        value: function (value) {
            ...
            } else <span class="missing-if-branch" title="if path not taken" >I</span>if (this._labelNode) {
<span class="cstat-no" title="statement not covered" >                this._labelNode.data = value;</span>
            }
        }
    },
&nbsp;
