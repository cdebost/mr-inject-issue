...
<html lang="en">
<head>
    <title>Code coverage report for montage/ui/modal-overlay.reel/modal-overlay.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">montage/ui/modal-overlay.reel/</a> modal-overlay.js
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >                    this._slotComponent.content = component;</span>
                }
&nbsp;
                queue.push(this);
&nbsp;
...
&nbsp;
            ...
            } else <span class="missing-if-branch" title="else path not taken" >E</span>if (ix &gt; 0) {
                queue.splice(ix, 1);
