...
<html lang="en">
<head>
    <title>Code coverage report for montage/ui/base/abstract-select.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">montage/ui/base/</a> abstract-select.js
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >                this._labelPropertyName = "label";</span>
            }
            this._contentIsDirty = true;
            this.needsDraw = true;
        },
        get: <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >            return this._labelPropertyName;</span>
        }
    },
&nbsp;
    _value: {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (event.touch) {</span>
...
<span class="cstat-no" title="statement not covered" >                this.element.setAttribute("role", "listbox");</span>
            }
        }
    }
&nbsp;
