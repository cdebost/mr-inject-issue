...
<html lang="en">
<head>
    <title>Code coverage report for montage/ui/base/abstract-number-field.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">montage/ui/base/</a> abstract-number-field.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">83.76% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>98/117</span>
      </div>
      <div class='fl pad1y space-right2'>
...
&nbsp;
    textFieldShouldAcceptValue: {
        value: <span class="fstat-no" title="function not covered" >function (textField, value) {</span>
<span class="cstat-no" title="statement not covered" >            if (this._activeValueChange === true) {</span>
...
&nbsp;
    ...
    handleMinusAction: {
        value: function () {
            ...
            var value = (this.value * this._stepDecimal) - stepBase;
            if (value % step) {
                <span class="missing-if-branch" title="else path not taken" >E</span>if (value &gt; 0) {
                    value -= value % step;
                } else {
...
<span class="cstat-no" title="statement not covered" >                this.handlePlusAction();</span>
            } else <span class="cstat-no" title="statement not covered" >if (event.identifier === "decrease") {</span>
<span class="cstat-no" title="statement not covered" >                this.handleMinusAction();</span>
            }
        }
    },
&nbsp;
    handleAction: {
        value: function (event) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (event.target === this._numberFieldTextFieldComponent ||
