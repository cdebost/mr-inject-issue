...
<html lang="en">
<head>
    <title>Code coverage report for montage/ui/base/abstract-text-field.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">montage/ui/base/</a> abstract-text-field.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    placeholder: {
        ...
        get: <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >            return this._placeholder;</span>
        }
    },
&nbsp;
    _value: {
...
<span class="cstat-no" title="statement not covered" >                displayValue = this.converter.convert(displayValue);</span>
            }
&nbsp;
...
&nbsp;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (this.eventManager.activeTarget === this &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >typeof this.element.setSelectionRange === "function")</span> {
                // restore the previous cursor position.
                // TODO: contenteditable?
<span class="cstat-no" title="statement not covered" >                this.element.setSelectionRange(start, end);</span>
            }   
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                    value = this.converter.revert(displayedValue);</span>
<span class="cstat-no" title="statement not covered" >                    this.errorMessage = null;</span>
&nbsp;
                } catch (error) {
<span class="cstat-no" title="statement not covered" >                    this.errorMessage = error.message || error;</span>
                }
            }
&nbsp;
            <span class="missing-if-branch" title="else path not taken" >E</span>if (this._value !== value) {
                this._value = value;
&nbsp;
