...
<html lang="en">
<head>
    <title>Code coverage report for montage/core/extras/regexp.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">montage/core/extras/</a> regexp.js
    </h1>
    <div class='clearfix'>
 ...
 */
<span class="missing-if-branch" title="else path not taken" >E</span>if (!RegExp.isRegExp) {
