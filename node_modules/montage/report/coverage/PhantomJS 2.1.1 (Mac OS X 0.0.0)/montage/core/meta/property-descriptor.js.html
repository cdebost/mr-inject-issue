...
<html lang="en">
<head>
    <title>Code coverage report for montage/core/meta/property-descriptor.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">montage/core/meta/</a> property-descriptor.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">47.76% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>32/67</span>
      </div>
      <div class='fl pad1y space-right2'>
...
396
397
398</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1×</span>
...
&nbsp;
    ...
    initWithNameObjectDescriptorAndCardinality: {
        value:function (name, objectDescriptor, cardinality) {
            this._name = (name !== null ? name : <span class="branch-1 cbranch-no" title="branch not covered" >Defaults["name"])</span>;
            this._owner = objectDescriptor;
            this.cardinality = (cardinality &gt; 0 ? cardinality : <span class="branch-1 cbranch-no" title="branch not covered" >Defaults["cardinality"])</span>;
            return this;
        }
    },
&nbsp;
    ...
    initWithNameBlueprintAndCardinality: {
        value: deprecate.deprecateMethod(void 0, <span class="fstat-no" title="function not covered" >function (name, blueprint, cardinality) {</span>
<span class="cstat-no" title="statement not covered" >            return this.initWithNameObjectDescriptorAndCardinality(name, blueprint, cardinality);</span>
...
<span class="cstat-no" title="statement not covered" >            serializer.setProperty("objectDescriptor", this._owner, "reference");</span>
<span class="cstat-no" title="statement not covered" >            if (this.cardinality === Infinity) {</span>
<span class="cstat-no" title="statement not covered" >                serializer.setProperty("cardinality", -1);</span>
            } else {
<span class="cstat-no" title="statement not covered" >                this._setPropertyWithDefaults(serializer, "cardinality", this.cardinality);</span>
            }
<span class="cstat-no" title="statement not covered" >            this._setPropertyWithDefaults(serializer, "mandatory", this.mandatory);</span>
<span class="cstat-no" title="statement not covered" >            this._setPropertyWithDefaults(serializer, "readOnly", this.readOnly);</span>
<span class="cstat-no" title="statement not covered" >            this._setPropertyWithDefaults(serializer, "denyDelete", this.denyDelete);</span>
<span class="cstat-no" title="statement not covered" >            this._setPropertyWithDefaults(serializer, "valueType", this.valueType);</span>
<span class="cstat-no" title="statement not covered" >            this._setPropertyWithDefaults(serializer, "collectionValueType", this.collectionValueType);</span>
<span class="cstat-no" title="statement not covered" >            this._setPropertyWithDefaults(serializer, "valueObjectPrototypeName", this.valueObjectPrototypeName);</span>
<span class="cstat-no" title="statement not covered" >            this._setPropertyWithDefaults(serializer, "valueObjectModuleId", this.valueObjectModuleId);</span>
<span class="cstat-no" title="statement not covered" >            this._setPropertyWithDefaults(serializer, "valueDescriptor", this._valueDescriptorReference);</span>
<span class="cstat-no" title="statement not covered" >            if (this.enumValues.length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >                this._setPropertyWithDefaults(serializer, "enumValues", this.enumValues);</span>
            }
<span class="cstat-no" title="statement not covered" >            this._setPropertyWithDefaults(serializer, "defaultValue", this.defaultValue);</span>
<span class="cstat-no" title="statement not covered" >            this._setPropertyWithDefaults(serializer, "helpKey", this.helpKey);</span>
<span class="cstat-no" title="statement not covered" >            this._setPropertyWithDefaults(serializer, "definition", this.definition);</span>
        }
    },
&nbsp;
    deserializeSelf: {
...
<span class="cstat-no" title="statement not covered" >                this.synonym = value;</span>
            }
        }
    },
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            return this._owner;</span>
        }
    },
&nbsp;
    _name: {
...
&nbsp;
    ...
    isToMany: {
        get:<span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >            return this.cardinality === Infinity || this.cardinality &gt; 1;</span>
        }
    },
&nbsp;
    /**
...
&nbsp;
    ...
    valueDescriptor: {
        serializable: false,
        get: <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >            return this._valueDescriptorReference &amp;&amp; this._valueDescriptorReference.promise(this.require);</span>
        },
        set: <span class="fstat-no" title="function not covered" >function (descriptor) {</span>
<span class="cstat-no" title="statement not covered" >            this._valueDescriptorReference = new ObjectDescriptorReference().initWithValue(descriptor);</span>
        }
    },
&nbsp;
...
&nbsp;
    ...
    enumValues: {
        get:<span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >            if (!this._enumValues) {</span>
<span class="cstat-no" title="statement not covered" >                return [];</span>
            }
<span class="cstat-no" title="statement not covered" >            return this._enumValues;</span>
        },
        set:function (value) {
...
<span class="cstat-no" title="statement not covered" >            return !!this._valueDescriptorReference;</span>
        }, "isAssociationBlueprint", "No analog")
    },
&nbsp;
    targetBlueprint: {
        get: deprecate.deprecateMethod(void 0, <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >            return this.valueDescriptor;</span>
...
<span class="cstat-no" title="statement not covered" >            this.valueDescriptor = value;</span>
