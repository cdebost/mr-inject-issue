 ...
 */
<span class="missing-if-branch" title="else path not taken" >E</span>if (!String.prototype.startsWith) {
 ...
 */
<span class="missing-if-branch" title="else path not taken" >E</span>if (!String.prototype.endsWith) {
