...
<html lang="en">
<head>
    <title>Code coverage report for montage/core/document-resources.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">montage/core/</a> document-resources.js
    </h1>
    <div class='clearfix'>
...
367
368
369</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1×</span>
...
&nbsp;
            <span class="missing-if-branch" title="else path not taken" >E</span>if ("onload" in link) {
...
&nbsp;
            forEach.call(links, function (link) {
                <span class="missing-if-branch" title="else path not taken" >E</span>if (link.rel === "stylesheet") {
...
<span class="cstat-no" title="statement not covered" >                return this._importScript(script);</span>
            }
        }
    },
&nbsp;
...
&nbsp;
                    ...
                    var loadingTimeout = setTimeout(<span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >                        self.setResourcePreloaded(url);</span>
    ...
    handleEvent: {
        value: function (event) {
            var target = event.target,
                index;
&nbsp;
            <span class="missing-if-branch" title="else path not taken" >E</span>if (target.tagName === "LINK") {
...
&nbsp;
            if (url) {
                ...
                <span class="missing-if-branch" title="else path not taken" >E</span>if (!this._isPollingDocumentStyleSheets) {
...
&nbsp;
    domain: {
        value: global.location ? global.location.protocol + "//" + global.location.host : <span class="branch-1 cbranch-no" title="branch not covered" >''</span>
    },
&nbsp;
    isCrossDomain: {
        value: function (url) {
...
&nbsp;
            if (skipPreload || this.isResourcePreloaded(url)) {
                return Promise.resolve();
            } else <span class="missing-if-branch" title="if path not taken" >I</span>if (this.isResourcePreloading(url)) {
<span class="cstat-no" title="statement not covered" >                return this.getResourcePreloadedPromise(url);</span>
            } else {
    ...
    areStylesLoaded: {
        get: function () {
            var styleSheets,
                ix;
&nbsp;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (this._isPollingDocumentStyleSheets) {
<span class="cstat-no" title="statement not covered" >                if (this._expectedStyles.length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >                    styleSheets = this._document.styleSheets;</span>
<span class="cstat-no" title="statement not covered" >                    for (var i = 0, styleSheet; styleSheet = styleSheets[i]; i++) {</span>
<span class="cstat-no" title="statement not covered" >                        ix = this._expectedStyles.indexOf(styleSheet.href);</span>
<span class="cstat-no" title="statement not covered" >                        if (ix &gt;= 0) {</span>
<span class="cstat-no" title="statement not covered" >                            this._expectedStyles.splice(ix, 1);</span>
                        }
                    }
                }
            }
...
&nbsp;
            <span class="missing-if-branch" title="else path not taken" >E</span>if (!documentResources) {
