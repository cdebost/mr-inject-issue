...
<html lang="en">
<head>
    <title>Code coverage report for montage/core/serialization/deserializer/montage-reviver.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">all files</a> / <a href="index.html">montage/core/serialization/deserializer/</a> montage-reviver.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">90.07% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>263/292</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">84.18% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>149/177</span>
      </div>
      <div class='fl pad1y space-right2'>
...
781
782
783</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1×</span>
...
<span class="cstat-no" title="statement not covered" >                throw new Error("Function 'require' missing.");</span>
            }
&nbsp;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof _require.location !== "string") {
<span class="cstat-no" title="statement not covered" >                throw new Error("Function 'require' location is missing");</span>
            }
&nbsp;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof objectRequires !== "object" &amp;&amp;
                typeof objectRequires !== "undefined") {
<span class="cstat-no" title="statement not covered" >                throw new Error("Parameter 'objectRequires' should be an object.");</span>
            }
&nbsp;
    ...
    getModule: {
        value: function (moduleId, label) {
            var objectRequires = this._objectRequires,
                ...
                module;
&nbsp;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (objectRequires &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >label in objectRequires)</span> {
<span class="cstat-no" title="statement not covered" >                _require = objectRequires[label];</span>
            } else {
...
&nbsp;
    _checkLabel: {
        value: function (label, isTemplateProperty) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (isTemplateProperty &amp;&amp; label[0] !== ":") {
<span class="cstat-no" title="statement not covered" >                return new Error("Aliases can only be defined in template properties (start with a colon (:)), \"" + label + "\".");</span>
...
&nbsp;
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (value.debugger) {
<span class="cstat-no" title="statement not covered" >                console.log("enable debugger statement here");</span>
                //debugger;
            }
&nbsp;
            if ("value" in value) {
...
&nbsp;
                    <span class="missing-if-branch" title="else path not taken" >E</span>if (!Promise.is(revivedValue)) {
...
<span class="cstat-no" title="statement not covered" >                return Promise.reject(new Error("Element with id '" + elementId + "' was not found."));</span>
            }
        }
    },
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                    throw new Error('Error deserializing "' + label +</span>
                        '" when loading module "' + locationDesc.moduleId +
                        "' from '" + value.prototype + "' cause: " + error.message);
                });
            } else {
                <span class="missing-if-branch" title="if path not taken" >I</span>if ("object" in value &amp;&amp; value.object.endsWith(".mjson")) {
<span class="cstat-no" title="statement not covered" >                    return self.instantiateMjsonObject(module, locationDesc.moduleId);</span>
                } else {
...
<span class="cstat-no" title="statement not covered" >                        if (module.redirect) {</span>
<span class="cstat-no" title="statement not covered" >                            topId = module.redirect;</span>
                        } else {
<span class="cstat-no" title="statement not covered" >                            parentRequire = module.mappingRequire;</span>
<span class="cstat-no" title="statement not covered" >                            topId = module.mappingRedirect;</span>
                        }
<span class="cstat-no" title="statement not covered" >                        module = parentRequire.getModuleDescriptor(topId);</span>
                    }
...
&nbsp;
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (object !== null &amp;&amp; object !== void 0) {
...
&nbsp;
                <span class="missing-if-branch" title="if path not taken" >I</span>if (Promise.is(properties)) {
<span class="cstat-no" title="statement not covered" >                    return properties.then(<span class="fstat-no" title="function not covered" >function() {</span></span>
...
&nbsp;
    deserializeMontageObjectProperties: {
        value: function (object, properties, context) {
            var value;
&nbsp;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof object.deserializeProperties === "function") {
<span class="cstat-no" title="statement not covered" >                var propertiesDeserializer = new PropertiesDeserializer()</span>
                    .initWithReviverAndObjects(this, context);
<span class="cstat-no" title="statement not covered" >                value = object.deserializeProperties(propertiesDeserializer);</span>
            } else {
...
&nbsp;
                <span class="missing-if-branch" title="if path not taken" >I</span>if (!(objectName in module)) {
<span class="cstat-no" title="statement not covered" >                    throw new Error('Error deserializing "' + label +</span>
                ...
                object.isDeserializing = true;
                <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof object.didCreate === "function") {
<span class="cstat-no" title="statement not covered" >                    object.didCreate();</span>
                } else <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof object.constructor === "function") {
                    object.constructor();
                }
                return object;
...
&nbsp;
            if (Promise.is(value)) {
                return value.then(<span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >                    self._invokeDeserializedFromSerialization(objects, context);</span>
                });
            } else {
...
&nbsp;
            <span class="missing-if-branch" title="else path not taken" >E</span>if (label) {
...
&nbsp;
                <span class="missing-if-branch" title="if path not taken" >I</span>if (Promise.is(item)) {
...
&nbsp;
            <span class="missing-if-branch" title="else path not taken" >E</span>if (promises.length === 0) {
                return value;
            } else {
...
&nbsp;
                if (typeof reviver[methodName] === "function"
                    ...
                    <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof customObjectRevivers[methodName] === "undefined") {
                        customObjectRevivers[methodName] = reviver[methodName].bind(reviver);
                    } else {
<span class="cstat-no" title="statement not covered" >                        return new Error("Reviver '" + methodName + "' is already registered.");</span>
                    }
                }
            }
&nbsp;
...
&nbsp;
    resetCustomObjectRevivers: {
        value: function() {
            ...
            this.prototype.getCustomObjectTypeOf = <span class="fstat-no" title="function not covered" >function() {</span>};
        }
    },
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                return getCustomObjectTypeOf(value) || previousGetCustomObjectTypeOf(value);</span>
            }
        }
    }
&nbsp;
