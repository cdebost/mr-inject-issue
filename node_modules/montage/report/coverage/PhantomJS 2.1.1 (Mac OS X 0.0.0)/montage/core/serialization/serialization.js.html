...
<html lang="en">
<head>
    <title>Code coverage report for montage/core/serialization/serialization.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">montage/core/serialization/</a> serialization.js
    </h1>
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        <span class="strong">84.28% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>134/159</span>
      </div>
      <div class='fl pad1y space-right2'>
...
&nbsp;
    getSerializationString: {
        value: function () {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (!this._serializationString) {
...
&nbsp;
            if (!this._serializationLabels) {
                <span class="missing-if-branch" title="else path not taken" >E</span>if (serializationObject = this.getSerializationObject()) {
...
<span class="cstat-no" title="statement not covered" >            var serializationObject = this.getSerializationObject(),</span>
                labels = [];
&nbsp;
<span class="cstat-no" title="statement not covered" >            for (var label in serializationObject) {</span>
<span class="cstat-no" title="statement not covered" >                if (Object.keys(serializationObject[label]).length === 0) {</span>
...
&nbsp;
            <span class="missing-if-branch" title="else path not taken" >E</span>if (serializationObject &amp;&amp; label in serializationObject) {
...
<span class="cstat-no" title="statement not covered" >            var serializationObject = this.getSerializationObject();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (serializationObject &amp;&amp; label in serializationObject) {</span>
<span class="cstat-no" title="statement not covered" >                return "alias" in serializationObject[label];</span>
            } else {
<span class="cstat-no" title="statement not covered" >                return false;</span>
            }
        }
...
&nbsp;
    getElementId: {
        value: <span class="fstat-no" title="function not covered" >function (label) {</span>
<span class="cstat-no" title="statement not covered" >            var object = this.getSerializationObject();</span>
&nbsp;
            // TODO: much faster than using the visitor, need to make the visitor
            // faster.
<span class="cstat-no" title="statement not covered" >            var element = Montage.getPath.call(object, label + ".properties.element");</span>
...
&nbsp;
            ...
            inspector.visitSerialization(function (node) {
                ...
                if (node.type === "Element" &amp;&amp; elementIds.indexOf(node.data) &gt;= 0) {
                    ...
                    node = node.parent;
                    <span class="missing-if-branch" title="else path not taken" >E</span>if (node &amp;&amp; node.name === "properties") {
                        // Check if it's in a montage object
                        node = node.parent;
                        <span class="missing-if-branch" title="else path not taken" >E</span>if (node &amp;&amp; node.type === "montageObject") {
...
&nbsp;
    renameElementReferences: {
        value: <span class="fstat-no" title="function not covered" >function (elementsTable) {</span>
<span class="cstat-no" title="statement not covered" >            var inspector = new SerializationInspector();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            inspector.initWithSerialization(this);</span>
<span class="cstat-no" title="statement not covered" >            inspector.visitSerialization(<span class="fstat-no" title="function not covered" >function (node) {</span></span>
<span class="cstat-no" title="statement not covered" >                if (node.type === "Element" &amp;&amp; node.data in elementsTable) {</span>
<span class="cstat-no" title="statement not covered" >                    node.data = elementsTable[node.data];</span>
                }
            });
        }
    },
...
&nbsp;
                    <span class="missing-if-branch" title="else path not taken" >E</span>if (reference in labelsTable) {
...
&nbsp;
    mergeSerialization: {
        value: <span class="fstat-no" title="function not covered" >function (serialization, delegate) {</span>
<span class="cstat-no" title="statement not covered" >            return SerializationMerger.mergeSerializations(this, serialization, delegate);</span>
        }
    },
&nbsp;
    extractSerialization: {
        value: <span class="fstat-no" title="function not covered" >function (labels, externalLabels) {</span>
<span class="cstat-no" title="statement not covered" >            var extractor = new SerializationExtractor();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            extractor.initWithSerialization(this);</span>
<span class="cstat-no" title="statement not covered" >            return extractor.extractSerialization(labels, externalLabels);</span>
        }
    }
});
&nbsp;
    ...
    _willMergeObjectWithLabel: {
        value: function (delegate, serialization1, serialization2, collisionTable) {
            var newLabel,
                ...
                labels2 = serialization2.getSerializationLabels();
&nbsp;
            <span class="missing-if-branch" title="else path not taken" >E</span>if (collisionTable) {
                collisionLabels = [];
...
&nbsp;
            if (serialization.hasSerializationLabel(label)) {
                ...
                if (ix &gt; 0) {
                    ...
                    <span class="missing-if-branch" title="else path not taken" >E</span>if (serialization.hasSerializationLabel(componentLabel)) {
                        return true;
                    }
                }
            }
...
&nbsp;
    visitSerializationObject: {
        value: function (label, visitor) {
            var serialization = this._serialization.getSerializationObject();
&nbsp;
            <span class="missing-if-branch" title="else path not taken" >E</span>if (label in serialization) {
                this._walkRootObject(visitor, serialization, label);
                this._serialization.initWithObject(serialization);
            } else {
<span class="cstat-no" title="statement not covered" >                throw new Error('Object "' + label + '" does not exist in ' + this._serialization.getSerializationString());</span>
            }
        }
    },
&nbsp;
...
&nbsp;
            } else <span class="missing-if-branch" title="else path not taken" >E</span>if (type === "object") {
                value.data = object;
                visitor(value);
                parentObject[key] = object = value.data;
&nbsp;
...
&nbsp;
            if (modified) {
                <span class="missing-if-branch" title="else path not taken" >E</span>if ("&lt;-" in object) {
                    object["&lt;-"] = stringify(parseTree);
                } else {
<span class="cstat-no" title="statement not covered" >                    object["&lt;-&gt;"] = stringify(parseTree);</span>
                }
            }
&nbsp;
            if (object.converter) {
...
&nbsp;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof object.default === "object") {
<span class="cstat-no" title="statement not covered" >                this._walkBindingData(visitor, object.default, value);</span>
            }
&nbsp;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof object.data === "object") {
<span class="cstat-no" title="statement not covered" >                data = object.data;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                for (var key in data) {</span>
<span class="cstat-no" title="statement not covered" >                    this._walkBindingData(visitor, data[key], value);</span>
                }
            }
        }
    },
