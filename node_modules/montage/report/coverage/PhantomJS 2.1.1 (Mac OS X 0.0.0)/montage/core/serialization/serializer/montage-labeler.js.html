...
<html lang="en">
<head>
    <title>Code coverage report for montage/core/serialization/serializer/montage-labeler.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">all files</a> / <a href="index.html">montage/core/serialization/serializer/</a> montage-labeler.js
    </h1>
    <div class='clearfix'>
...
187
188
189</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1×</span>
...
&nbsp;
            if (identifier &amp;&amp; this._labelRegexp.test(identifier)) {
                ...
                if (Array.isArray(object)) {
                    objectName = "array";
                } else <span class="missing-if-branch" title="if path not taken" >I</span>if (RegExp.isRegExp(object)) {
<span class="cstat-no" title="statement not covered" >                    objectName = "regexp";</span>
                } else {
...
<span class="cstat-no" title="statement not covered" >            this._labels = null;</span>
<span class="cstat-no" title="statement not covered" >            this._objectsLabels = null;</span>
<span class="cstat-no" title="statement not covered" >            this._objects = null;</span>
<span class="cstat-no" title="statement not covered" >            this._baseNamesIndex = null;</span>
<span class="cstat-no" title="statement not covered" >            this._userDefinedLabels = null;</span>
        }
    },
&nbsp;
    generateLabel: {
