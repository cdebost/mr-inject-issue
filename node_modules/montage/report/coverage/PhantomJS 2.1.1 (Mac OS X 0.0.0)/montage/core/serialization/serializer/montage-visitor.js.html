...
<html lang="en">
<head>
    <title>Code coverage report for montage/core/serialization/serializer/montage-visitor.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">all files</a> / <a href="index.html">montage/core/serialization/serializer/</a> montage-visitor.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">93.68% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>163/174</span>
      </div>
      <div class='fl pad1y space-right2'>
...
581
582
583</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1×</span>
...
<span class="cstat-no" title="statement not covered" >                throw new Error("Not possible to serialize a DOM element with no " + this._MONTAGE_ID_ATTRIBUTE + " assigned: " + element.outerHTML);</span>
            }
        }
    },
&nbsp;
    ...
    setObjectCustomUnit: {
        value: function (malker, object, unitName) {
            var unit = this._units[unitName],
                ...
                unitSerializer;
&nbsp;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (!unit) {
...
<span class="cstat-no" title="statement not covered" >            var type = this.getCustomObjectTypeOf(object);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            return typeof type === "string";</span>
        }
    },
&nbsp;
...
&nbsp;
    visitCustomObject: {
        value: <span class="fstat-no" title="function not covered" >function(malker, object, name) {</span>
<span class="cstat-no" title="statement not covered" >            var type = this.getCustomObjectTypeOf(object),</span>
                method = MontageVisitor.customObjectVisitors["visit" + type];
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (type) {</span>
<span class="cstat-no" title="statement not covered" >                return method.call(global, malker, this, object, name);</span>
            } else {
<span class="cstat-no" title="statement not covered" >                throw new Error("Object's type is unknown: " + object);</span>
            }
        }
    },
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                return getCustomObjectTypeOf(value) ||</span>
...
&nbsp;
                <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof visitor[methodName] === "function"
                    &amp;&amp; /^visit/.test(methodName)) {
                    <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof customObjectVisitors[methodName] === "undefined") {
                        customObjectVisitors[methodName] = visitor[methodName].bind(visitor);
                    } else {
<span class="cstat-no" title="statement not covered" >                        return new Error("Visitor '" + methodName + "' is already registered.");</span>
                    }
                }
            }
&nbsp;
