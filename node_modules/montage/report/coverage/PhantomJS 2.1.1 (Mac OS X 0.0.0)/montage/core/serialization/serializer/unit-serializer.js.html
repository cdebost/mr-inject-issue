...
<html lang="en">
<head>
    <title>Code coverage report for montage/core/serialization/serializer/unit-serializer.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">all files</a> / <a href="index.html">montage/core/serialization/serializer/</a> unit-serializer.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    addObject: {
        value: function (object) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof object === "object") {
