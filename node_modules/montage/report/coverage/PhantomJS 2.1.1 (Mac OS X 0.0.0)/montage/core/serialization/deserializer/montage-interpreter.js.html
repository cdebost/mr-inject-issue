...
<html lang="en">
<head>
    <title>Code coverage report for montage/core/serialization/deserializer/montage-interpreter.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">all files</a> / <a href="index.html">montage/core/serialization/deserializer/</a> montage-interpreter.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
                ...
                <span class="missing-if-branch" title="if path not taken" >I</span>if (locationId) {
<span class="cstat-no" title="statement not covered" >                    locationDesc = MontageReviver.parseObjectLocationId(locationId);</span>
<span class="cstat-no" title="statement not covered" >                    module = moduleLoader.getModule(</span>
                        locationDesc.moduleId, label);
<span class="cstat-no" title="statement not covered" >                    if (Promise.is(module)) {</span>
<span class="cstat-no" title="statement not covered" >                        promises.push(module);</span>
                    }
                }
            }
&nbsp;
...
&nbsp;
    getUserObject: {
        value: function(label) {
            var userObjects = this._userObjects;
&nbsp;
            <span class="missing-if-branch" title="else path not taken" >E</span>if (userObjects) {
    ...
    _invokeDidReviveObjects: {
        value: function() {
            var self = this,
                ...
                result;
&nbsp;
            <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof reviver.didReviveObjects === "function") {
                result = reviver.didReviveObjects(this._objects, this);
                if (Promise.is(result)) {
                    return result.then(<span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >                        return self._objects;</span>
                    });
                }
            }
&nbsp;
