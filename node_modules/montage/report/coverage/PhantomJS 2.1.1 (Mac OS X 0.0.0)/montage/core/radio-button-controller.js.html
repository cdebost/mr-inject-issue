...
<html lang="en">
<head>
    <title>Code coverage report for montage/core/radio-button-controller.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">montage/core/</a> radio-button-controller.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    ...
    registerRadioButton: {
        value: function (radioButton) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (this._radioButtons.indexOf(radioButton) === -1) {
...
&nbsp;
    ...
    unregisterRadioButton: {
        value: <span class="fstat-no" title="function not covered" >function (radioButton) {</span>
<span class="cstat-no" title="statement not covered" >            var ix = this._radioButtons.indexOf(radioButton);</span>
<span class="cstat-no" title="statement not covered" >            if (ix &gt;= 0) {</span>
<span class="cstat-no" title="statement not covered" >                this._radioButtons.splice(ix, 1);</span>
<span class="cstat-no" title="statement not covered" >                if (radioButton === this.selectedRadioButton) {</span>
<span class="cstat-no" title="statement not covered" >                    this.selectedRadioButton = null;</span>
                }
            }
        }
    },
