...
<html lang="en">
<head>
    <title>Code coverage report for montage/core/gate.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">montage/core/</a> gate.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3739×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3739×</span>
...
<span class="cline-any cline-yes">3739×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1813×</span>
<span class="cline-any cline-yes">1926×</span>
...
<span class="cstat-no" title="statement not covered" >            var table = this.table;</span>
<span class="cstat-no" title="statement not covered" >            return !table || table[aFieldName];</span>
        }
    },
&nbsp;
    /**
    ...
    setField: {
        ...
        value: function (aFieldName, value) {
            var table = this.table || (<span class="branch-1 cbranch-no" title="branch not covered" >this.table = new Map())</span>,
                fieldValue,
                oldCount = this.count;
&nbsp;
...
&nbsp;
            ...
            } else <span class="missing-if-branch" title="if path not taken" >I</span>if (value &amp;&amp; logger.isDebug) {
<span class="cstat-no" title="statement not covered" >                logger.debug(this, aFieldName + " was not set before.");</span>
            }
...
&nbsp;
    ...
    removeField: {
        enumerable: false,
        value: <span class="fstat-no" title="function not covered" >function (aFieldName) {</span>
<span class="cstat-no" title="statement not covered" >            var table = this.table, fieldValue = table[aFieldName];</span>
<span class="cstat-no" title="statement not covered" >            if (typeof fieldValue !== "undefined" &amp;&amp; !fieldValue) {</span>
                // if the value was false decrement the count
<span class="cstat-no" title="statement not covered" >                this.count--;</span>
            }
<span class="cstat-no" title="statement not covered" >            delete table[aFieldName];</span>
        }
    },
&nbsp;
    /**
