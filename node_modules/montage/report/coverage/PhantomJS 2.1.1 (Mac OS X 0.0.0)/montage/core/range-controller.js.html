...
<html lang="en">
<head>
    <title>Code coverage report for montage/core/range-controller.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">montage/core/</a> range-controller.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">50.28% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>90/179</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">40.5% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>49/121</span>
      </div>
      <div class='fl pad1y space-right2'>
...
858
859
860</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
Object.defineProperty(_RangeSelection.prototype, "swap_or_push", {
    ...
    value: function(start, howMany, itemsToAdd) {
        ...
        start = start &gt;= 0 ? start : <span class="branch-1 cbranch-no" title="branch not covered" >this.length + start;</span>
        var oldLength = this.length;
        var minusLength = Math.min(howMany, oldLength - start);
&nbsp;
		<span class="missing-if-branch" title="else path not taken" >E</span>if(itemsToAdd) {
&nbsp;
...
&nbsp;
            var plus = itemsToAdd.filter(function(item, index){
                ...
                <span class="missing-if-branch" title="if path not taken" >I</span>if (content &amp;&amp; !content.has(item)) {
<span class="cstat-no" title="statement not covered" >                    return false;</span>
                }
&nbsp;
                // if the same item appears twice in the add list, only add it once
                <span class="missing-if-branch" title="if path not taken" >I</span>if (itemsToAdd.findLast(item) &gt; index) {
<span class="cstat-no" title="statement not covered" >                    return false;</span>
                }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >			plus = EMPTY_ARRAY;</span>
		}
&nbsp;
&nbsp;
        var minus;
...
&nbsp;
        if (!this.rangeController.allowsMultipleSelection &amp;&amp; newLength &gt; 1) {
            ...
            var last = plus.length ? plus[plus.length-1] : <span class="branch-1 cbranch-no" title="branch not covered" >this.one();</span>
            <span class="missing-if-branch" title="if path not taken" >I</span>if(oldLength === 0) {
<span class="cstat-no" title="statement not covered" >                this.oldPush(last);</span>
<span class="cstat-no" title="statement not covered" >                return EMPTY_ARRAY;</span>
            }
            else {
                return this.oldSwap(0, oldLength, [last]);
            }
        } else <span class="missing-if-branch" title="if path not taken" >I</span>if (this.rangeController.avoidsEmptySelection &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >newLength === 0)</span> {
            // use the first item in the selection, unless it is no longer in the content
<span class="cstat-no" title="statement not covered" >            if (content.has(this[0])) {</span>
<span class="cstat-no" title="statement not covered" >                if((this.length-1) === 0) {</span>
<span class="cstat-no" title="statement not covered" >                    return EMPTY_ARRAY;</span>
                }
                else {
<span class="cstat-no" title="statement not covered" >                    return this.oldSwap(1, this.length-1);</span>
                }
            } else {
<span class="cstat-no" title="statement not covered" >                if(this.length === 0) {</span>
<span class="cstat-no" title="statement not covered" >                    this.oldPush(content.one());</span>
<span class="cstat-no" title="statement not covered" >                    return EMPTY_ARRAY;</span>
                }
                else {
<span class="cstat-no" title="statement not covered" >                    return this.oldSwap(0, this.length, [content.one()]);</span>
                }
            }
        } else {
...
<span class="cstat-no" title="statement not covered" >                this.initWithContent(content);</span>
            }
        }
    },
&nbsp;
...
&nbsp;
     ...
     */
    multiSelect: {
        set: <span class="fstat-no" title="function not covered" >function (multiSelect) {</span>
<span class="cstat-no" title="statement not covered" >            deprecate.deprecationWarning("multiSelect", "allowsMultipleSelection");</span>
<span class="cstat-no" title="statement not covered" >            this.allowsMultipleSelection = !!multiSelect;</span>
        },
        get: <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >            deprecate.deprecationWarning("multiSelect", "allowsMultipleSelection");</span>
<span class="cstat-no" title="statement not covered" >            return this.allowsMultipleSelection;</span>
        }
    },
&nbsp;
&nbsp;
...
&nbsp;
    ...
    selection: {
        ...
        set: function (collection) {
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (collection &amp;&amp; collection.toArray) {
...
<span class="cstat-no" title="statement not covered" >            if (!this.allowsMultipleSelection &amp;&amp; this.selection.length &gt;= 1) {</span>
<span class="cstat-no" title="statement not covered" >                this.selection.clear();</span>
            }
<span class="cstat-no" title="statement not covered" >            this.selection.add(value);</span>
        }
    },
&nbsp;
    /**
    ...
    deselect: {
        value: <span class="fstat-no" title="function not covered" >function (value) {</span>
<span class="cstat-no" title="statement not covered" >            if (!this.avoidsEmptySelection || this.selection.length &gt; 1) {</span>
<span class="cstat-no" title="statement not covered" >                this.selection["delete"](value);</span>
            }
        }
    },
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            result = this.content.add(value);</span>
<span class="cstat-no" title="statement not covered" >            if (result) {</span>
<span class="cstat-no" title="statement not covered" >                this.handleAdd(value);</span>
            }
...
&nbsp;
    ...
    push: {
        value: <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >            var result = this.content.push.apply(this.content, arguments);</span>
<span class="cstat-no" title="statement not covered" >            for (var index = 0; index &lt; arguments.length; index++) {</span>
<span class="cstat-no" title="statement not covered" >                this.handleAdd(arguments[index]);</span>
            }
<span class="cstat-no" title="statement not covered" >            return result;</span>
        }
    },
&nbsp;
    ...
    pop: {
        value: <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >            return this.content.pop();</span>
        }
    },
&nbsp;
    /**
    ...
    shift: {
        value: <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >            return this.content.shift();</span>
        }
    },
&nbsp;
    /**
    ...
    unshift: {
        value: <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >            var result = this.content.unshift.apply(this.content, arguments);</span>
<span class="cstat-no" title="statement not covered" >            for (var index = 0; index &lt; arguments.length; index++) {</span>
<span class="cstat-no" title="statement not covered" >                this.handleAdd(arguments[index]);</span>
            }
<span class="cstat-no" title="statement not covered" >            return result;</span>
...
&nbsp;
    ...
    splice: {
        value: <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >            var result = this.content.splice.apply(this.content, arguments);</span>
<span class="cstat-no" title="statement not covered" >            for (var index = 2; index &lt; arguments.length; index++) {</span>
<span class="cstat-no" title="statement not covered" >                this.handleAdd(arguments[index]);</span>
            }
<span class="cstat-no" title="statement not covered" >            return result;</span>
        }
...
&nbsp;
     ...
     */
    swap: {
        value: <span class="fstat-no" title="function not covered" >function (index, length, values) {</span>
<span class="cstat-no" title="statement not covered" >            var result = this.content.swap.apply(this.content, arguments);</span>
<span class="cstat-no" title="statement not covered" >            if (values) {</span>
<span class="cstat-no" title="statement not covered" >                for (var index = 2; index &lt; values.length; index++) {</span>
<span class="cstat-no" title="statement not covered" >                    this.handleAdd(values[index]);</span>
                }
            }
<span class="cstat-no" title="statement not covered" >            return result;</span>
        }
...
&nbsp;
    ...
    "delete": {
        value: <span class="fstat-no" title="function not covered" >function (value) {</span>
<span class="cstat-no" title="statement not covered" >            return this.content["delete"](value);</span>
        }
    },
&nbsp;
    /**
    ...
    has: {
        value: <span class="fstat-no" title="function not covered" >function (value) {</span>
<span class="cstat-no" title="statement not covered" >            if (this.content) {</span>
<span class="cstat-no" title="statement not covered" >                return this.content.has(value);</span>
            } else {
<span class="cstat-no" title="statement not covered" >                return false;</span>
            }
        }
...
&nbsp;
    ...
    addContent: {
        value: <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >            var content = new this.contentConstructor();</span>
<span class="cstat-no" title="statement not covered" >            this.add(content);</span>
...
&nbsp;
    ...
    contentConstructor: {
        get: <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >            if (this._contentConstructor) {</span>
<span class="cstat-no" title="statement not covered" >                return this._contentConstructor;</span>
            } else <span class="cstat-no" title="statement not covered" >if (this.content &amp;&amp; this.content.contentConstructor) {</span>
<span class="cstat-no" title="statement not covered" >                return this.content.contentConstructor;</span>
            } else {
<span class="cstat-no" title="statement not covered" >                return Object;</span>
            }
        },
        set: <span class="fstat-no" title="function not covered" >function (contentConstructor) {</span>
<span class="cstat-no" title="statement not covered" >            this._contentConstructor = contentConstructor;</span>
        }
    },
&nbsp;
    /**
...
&nbsp;
                <span class="missing-if-branch" title="else path not taken" >E</span>if (this.selection.length) {
                    this.selection.deleteEach(minus);
&nbsp;
                    // ensure selection always has content
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.selection.length === 0 &amp;&amp; this.content &amp;&amp; this.content.length &amp;&amp;
                        this.avoidsEmptySelection &amp;&amp; <span class="branch-4 cbranch-no" title="branch not covered" >!this.allowsMultipleSelection)</span> {
                        // selection can't contain previous content value as content already changed
<span class="cstat-no" title="statement not covered" >                        this.selection.add(this.content[this.content.length - 1]);</span>
                    }
                }
            }
        }
...
<span class="cstat-no" title="statement not covered" >                if (this.content) {</span>
<span class="cstat-no" title="statement not covered" >                    var notInContent = [];</span>
<span class="cstat-no" title="statement not covered" >                    for (var i=0;i&lt;plus.length;i++) {</span>
<span class="cstat-no" title="statement not covered" >                        if (!this.content.has(plus[i])) {</span>
<span class="cstat-no" title="statement not covered" >                            notInContent.push(plus[i]);</span>
                        }
                    }
<span class="cstat-no" title="statement not covered" >                    this._selection.deleteEach(notInContent);</span>
<span class="cstat-no" title="statement not covered" >                    if (!this.allowsMultipleSelection &amp;&amp; this._selection.length &gt; 1) {</span>
<span class="cstat-no" title="statement not covered" >                        var last = this._selection.pop();</span>
<span class="cstat-no" title="statement not covered" >                        this._selection.clear();</span>
<span class="cstat-no" title="statement not covered" >                        this._selection.add(last);</span>
                    }
<span class="cstat-no" title="statement not covered" >                    if (this.avoidsEmptySelection &amp;&amp; this._selection.length == 0) {</span>
<span class="cstat-no" title="statement not covered" >                        this._selection.add(minus[0]);</span>
                    }
                } else {
<span class="cstat-no" title="statement not covered" >                    this._selection.clear();</span>
                }
...
&nbsp;
    ...
    handleOrganizedContentRangeChange: {
        value: function (plus, minus, index) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (this.deselectInvisibleContent &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >this.selection)</span> {
<span class="cstat-no" title="statement not covered" >                var diff = minus.clone(1);</span>
<span class="cstat-no" title="statement not covered" >                diff.deleteEach(plus);</span>
<span class="cstat-no" title="statement not covered" >                this.selection.deleteEach(minus);</span>
            }
        }
    },
&nbsp;
    ...
    handleOrderChange: {
        value: function () {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (this.clearSelectionOnOrderChange &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >this.selection)</span> {
<span class="cstat-no" title="statement not covered" >                this.selection.clear();</span>
            }
        }
    },
&nbsp;
    ...
    handleAdd: {
        value: <span class="fstat-no" title="function not covered" >function (value) {</span>
<span class="cstat-no" title="statement not covered" >            if (this.selectAddedContent &amp;&amp; this.selection) {</span>
<span class="cstat-no" title="statement not covered" >                if (!this.allowsMultipleSelection &amp;&amp; this.selection.length) {</span>
<span class="cstat-no" title="statement not covered" >                    this.selection.swap(0, this.selection.length, [value]);</span>
                } else {
<span class="cstat-no" title="statement not covered" >                    this.selection.add(value);</span>
                }
            }
...
&nbsp;
    ...
    handleAllowsMultipleSelectionChange: {
        value: function () {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (this.selection) {
