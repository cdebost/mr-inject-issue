...
<html lang="en">
<head>
    <title>Code coverage report for montage/core/undo-manager.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">montage/core/</a> undo-manager.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">92.99% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>146/157</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// Consider proposal at https://rniwa.com/editing/undomanager.html
/**
...
<span class="cstat-no" title="statement not covered" >            return this._maxUndoCount;</span>
        },
        set: function (value) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (value === this._maxUndoCount) {
<span class="cstat-no" title="statement not covered" >                return;</span>
            }
&nbsp;
            this._maxUndoCount = value;
&nbsp;
            <span class="missing-if-branch" title="else path not taken" >E</span>if (this._maxUndoCount != null) {
                this._trimStacks();
            }
        }
&nbsp;
...
&nbsp;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (redoRemoveCount &gt; 0) {
<span class="cstat-no" title="statement not covered" >                this._redoStack.splice(0, redoRemoveCount);</span>
            }
        }
    },
&nbsp;
...
&nbsp;
    ...
    closeBatch: {
        value: function () {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.currentBatch) {
<span class="cstat-no" title="statement not covered" >                throw new Error("No batch operation to close");</span>
            }
&nbsp;
...
&nbsp;
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (this._redoStack.length === this._maxUndoCount) {
<span class="cstat-no" title="statement not covered" >                        this._redoStack.shift();</span>
                    }
&nbsp;
                    this._redoStack.push(operationPromise);
                } else {
&nbsp;
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (this._undoStack.length === this._maxUndoCount) {
<span class="cstat-no" title="statement not covered" >                        this._undoStack.shift();</span>
                    }
&nbsp;
                    this._undoStack.push(operationPromise);
&nbsp;
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.isRedoing &amp;&amp; this._redoStack.length &gt; 0) {
<span class="cstat-no" title="statement not covered" >                        this.clearRedo();</span>
                    }
                }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                entry.deferredOperationReject(e);</span>
...
<span class="cstat-no" title="statement not covered" >            this._undoStack.splice(0, this._undoStack.length);</span>
        }
    },
&nbsp;
    /**
    ...
    clearRedo: {
        value: <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >            this._redoStack.splice(0, this._redoStack.length);</span>
        }
    },
&nbsp;
    /**
...
Montage.defineProperty(exports, "defaultUndoManager", {
    get: function () {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!_defaultUndoManager) {
