...
<html lang="en">
<head>
    <title>Code coverage report for montage/core/geometry/cubic-bezier.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">montage/core/geometry/</a> cubic-bezier.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    ...
    init: {
        ...
        value: function (controlPoints) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (controlPoints !== null) {
                if (controlPoints.length === 2) {
                    this.p1 = controlPoints[0];
                    this.p2 = controlPoints[1];
                } else <span class="missing-if-branch" title="else path not taken" >E</span>if (controlPoints.length === 4) {
