...
<html lang="en">
<head>
    <title>Code coverage report for montage/composer/composer.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">montage/composer/</a> composer.js
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >            if (this._needsFrame !== value) {</span>
<span class="cstat-no" title="statement not covered" >                this._needsFrame = value;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (this._component &amp;&amp; value) {</span>
<span class="cstat-no" title="statement not covered" >                    this._component.scheduleComposer(this);</span>
                }
            }
        },
        get: <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >            return this._needsFrame;</span>
        }
    },
&nbsp;
    /**
...
&nbsp;
    ...
    _resolveDefaults: {
        value: function () {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.element &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >this.element == null </span>&amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >this.component != null)</span> {
<span class="cstat-no" title="statement not covered" >                this.element = this.component.element;</span>
            }
        }
    },
&nbsp;
...
&nbsp;
    isLoaded: {
        get: <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >            return this._isLoaded;</span>
        }
    },
&nbsp;
    /**
...
<span class="cstat-no" title="statement not covered" >                this.component.addComposer(this);</span>
            }
        }
    }
&nbsp;
...
&nbsp;
    isCoordinateOutsideRadius: {
        value: <span class="fstat-no" title="function not covered" >function (x, y, radius) {</span>
<span class="cstat-no" title="statement not covered" >            return x * x + y * y &gt; radius * radius;</span>
        }
    }
&nbsp;
});
